class Communication::SystemEmailsController < Communication::BaseController
  ...
  def moderate_pending
    ...
    redirect_to communication_system_email_preview_pending_path("proposal_notification_digest")
  end
  ...
  def send_pending
    ...
    redirect_to communication_system_emails_path
  end
