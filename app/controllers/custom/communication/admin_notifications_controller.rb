class Communication::AdminNotificationsController < Communication::BaseController
  ...
  def create
    ...
    if @admin_notification.save
      ...
      redirect_to [:communication, @admin_notification], notice: notice
    else
      render :new
    end
  end
  ...
  def destroy
    ...
    redirect_to communication_admin_notifications_path, notice: notice
  end
  ...
  def deliver
    ...
    redirect_to [:communication, @admin_notification]
  end
